    ...
    draw() {
        for (var x = 0; x < this.width; x++) {
            for (var y = 0; y < this.height; y++) {
                ...
                if (tile.lightSpot != null) {
                    this.engine.drawer.circle(new Position(x * this.tileWidth, y * this.tileHeight), 10, 0, -1, true, 1, tile.lightSpot.color.toStringWithoutAlpha(), tile.lightSpot.color.alpha * tile.lightSpot.tension);
